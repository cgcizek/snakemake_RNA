...
#------------------------------------------------------------------------------------------
# Read quantification from Salmon and create a tx2gene
#------------------------------------------------------------------------------------------
...
# Force the same order of samples in colData and quant.sf
...
Geneid <- as.characters(snakemake@params[["annot_col"]])
